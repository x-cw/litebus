...
// Description : Same-clock FAIL mux for adapter_slv while the domain is still
//               clocked (QCH power-down request / reset, D22 §10.4).
//               intercept level: REQ_R -> 1-beat RSP_RD FAIL; REQ_W absorbs
//               WD until last then RSP_WR FAIL; atomics RSP_RD then RSP_WR.
//============================================================================
