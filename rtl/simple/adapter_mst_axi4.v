...
// Description : AXI4 slave -> LiteBus. No AWATOP, no AXI5_EN, no atomic.
//============================================================================
...
`endif
    ...
    adapter_mst_axi_core #(
        ...
        .HAS_ATOMIC(0), .QOS_PW(QOS_PW), .USER_CMD_PW(USER_CMD_PW),
        .MOD_PW(MOD_PW), .MAX_RD_OST(MAX_RD_OST), .MAX_WR_OST(MAX_WR_OST)
`ifdef ADP_QCH_TO
        , .QCH_TO_W(QCH_TO_W)
`endif
    ) u_core (
