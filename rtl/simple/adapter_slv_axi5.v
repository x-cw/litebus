...
// Description : Independent LiteBus TNIU -> AXI5 master top (AWATOP).
//               Does not switch adapter_slv_axi4 via AXI5_EN.
//============================================================================
...
`endif
    ...
    adapter_slv_axi_core #(
        ...
        .HAS_ATOMIC(1), .USER_CMD_PW(USER_CMD_PW), .USER_RSP_PW(USER_RSP_PW),
